...
const initialState = {
  ...
  employee: {
    ...
    tableResults: {
      ...
      insurance: { month: 0, year: 0 },
      initialTax: { month: 0, year: 0 },
      taxableIncome: { month: 0, year: 0 },
      employerObligations: { month: 0, year: 0 },
      totalEmployerCost: { month: 0, year: 0 },
      taxWedge: { month: 0, year: 0 },
      taxWedgePercentage: { month: 0, year: 0 },
      childrenDiscountAmount: { month: 0, year: 0 },
      salaryMonthCount: 14,
      numberOfChildren: 0,
      taxationYear: latestTaxYear,
      ageGroup: "A30P",
  ...
  business: {
    ...
    minimumPresumedIncome: {
      ...
      turnoverAdjustment: false,
      kadAverageTurnover: 0,
      otherIncomeAdjustment: false,
      otherIncome: 0,
      reliefAdjustment: false,
      reliefType: "none",
      eligibleOperatingDays: 365,
    },
    discountOptions: {
    ...
    tableResults: {
      ...
      taxableIncome: { month: 0, year: 0 },
      accountingProfit: { month: 0, year: 0 },
      presumedIncome: { month: 0, year: 0 },
      presumedIncomeBreakdown: null,
